...
- **Functional**: Works correctly, handles edge cases
- **Accessible**: WCAG 2.1 AA compliant, keyboard navigable, screen reader friendly
- **Performant**: Optimized assets, efficient animations, fast load times
- **Distinctive**: Memorable, context-appropriate, genuinely designed
